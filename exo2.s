...
__main	
        ...
        mov r0, #0x00000030  					;; Enable clock sur GPIO F et E où sont branchés les leds (0x20 == 0b100000)
		; ;;														 									 (GPIO::FEDCBA)
        str r0, [r6]
		...
		ldr r8, = GPIO_PORTE_BASE+(PIN0<<2) ;BUMPER R
		ldr r9, = GPIO_PORTE_BASE+(PIN1<<2) ;BUMPER L
